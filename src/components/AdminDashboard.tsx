            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
              ...
              <div className="lg:col-span-2 space-y-4">
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="bg-gray-200 rounded-lg h-80 flex items-center justify-center border-2 border-blue-400">
                      <div className="text-center text-gray-500">
                        <Navigation className="size-16 mx-auto mb-3 text-blue-600 animate-pulse" />
                        <p className="text-sm">Mapa de seguimiento en tiempo real</p>
                        <p className="text-xs text-gray-400 mt-1">
                          {selectedDriver 
                            ? 'Mostrando ubicación del conductor'
                            : 'Mostrando todos los conductores activos'}
                        </p>
                      </div>
                    </div>
                  </CardContent>
