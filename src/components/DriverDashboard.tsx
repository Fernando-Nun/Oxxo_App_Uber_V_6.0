...
const mockCompletedTrips = [
  { id: 'VIA-001', date: '20 Nov', customer: 'Pedro Sánchez', payment: 245, rating: 5, duration: '22 min' },
  { id: 'VIA-002', date: '20 Nov', customer: 'Laura Torres', payment: 180, rating: 4, duration: '15 min' },
  { id: 'VIA-003', date: '19 Nov', customer: 'Roberto Díaz', payment: 320, rating: 5, duration: '35 min' },
];
            ...
            {tripStatus === 'none' ? (
              ...
              <Card className="border-2 border-blue-600">
                ...
                <CardContent className="space-y-4">
                  ...
                  {/* Real-time Map */}
                  <div className="bg-gray-200 rounded-lg h-40 flex items-center justify-center border-2 border-blue-400">
                    <div className="text-center text-gray-500">
                      <Navigation className="size-10 mx-auto mb-2 text-blue-600 animate-pulse" />
                      <p className="text-sm">Navegación GPS activa</p>
                      <p className="text-xs text-gray-400 mt-1">Siguiendo ruta al punto de recogida</p>
                    </div>
                  </div>
              ...
              <Card className="border-2 border-green-600">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="bg-gray-200 rounded-lg border-2 border-green-400" style={{ height: '60vh' }}>
                    <div className="h-full flex items-center justify-center">
                      <div className="text-center text-gray-500">
                        <Navigation className="size-12 mx-auto mb-2 text-green-600 animate-pulse" />
                        <p className="text-sm">Navegación en tiempo real</p>
                        <p className="text-xs text-gray-400 mt-1">Siguiendo ruta óptima</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="border-t pt-3">
                      ...
                      <div className="space-y-2">
                        {[mockActiveTrip.customer.name, 'María González', 'Carlos Ramírez'].slice(0, currentPassengers).map((passenger, index) => (
