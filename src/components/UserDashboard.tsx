          ...
          <TabsContent value="home" className="space-y-4">
            ...
            <Card className="bg-gradient-to-br from-red-600 to-red-800 text-white border-0">
              <CardContent className="pt-6">
                ...
                <p className="text-red-100 text-sm">¿A dónde quieres ir hoy?</p>
              </CardContent>
            </Card>
                  ...
                  <div className="space-y-4 py-4">
                    ...
                    <div className="bg-gray-200 rounded-lg h-40 flex items-center justify-center">
                      <div className="text-center text-gray-500">
                        <Navigation className="size-8 mx-auto mb-2" />
            ...
            {/* Driver Arriving - Mostrar información del conductor */}
            ...
            {tripStatus === 'in_progress' && (
              <Card className="border-2 border-red-600">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="bg-gray-200 rounded-lg border-2 border-blue-400" style={{ height: '60vh' }}>
                    <div className="h-full flex items-center justify-center">
                      <div className="text-center text-gray-500">
                        <Navigation className="size-12 mx-auto mb-2 text-blue-600 animate-pulse" />
                        <p className="text-sm">Navegación en tiempo real</p>
                        <p className="text-xs text-gray-400 mt-1">Actualizando ruta...</p>
                      </div>
                    </div>
                  </div>
